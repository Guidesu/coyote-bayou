...
/datum/weather/rain/fog/nashdown_event //I'm totally not using weather as a makeshift randomized event creator, shut up cactus.  This system already works.
	...
	telegraph_message_list = list( //Always reads as 'someone is sending (for)', in the radio font.
		"<font size=2><span class='green'><bold>\[Common\] The Mankara Shadow Council</b> has a demand...</span></font>",
		"<font size=2><span class='green'><bold>\[Common\] The Mankara Shadow Council</b> has a request...</font>",
	...
	weather_message_list = list(
		...
		"<span class='green'><font size=2>...For adventurers to loot the city of Mankara, east of Mankara, for supplies.</font>",
		"<span class='green'><font size=2>...For adventurers to loot the mines north of the Christus Saint Michaels hospital in Mankara.</font>",
		"<span class='green'><font size=2>...For adventurers to seek out the Chinese ghouls and raid their fortifications under Mankara.</font>",
		"<span class='green'><font size=2>...For adventurers to seek out the ruins of the park far east of Mankara and clear out its inhabitants.</font>",
		...
		"<span class='green'><font size=2>...For adventurers to make sure the Renegade fortress north of Mankara is destroyed.</font>",
		"<span class='green'><font size=2>...For adventurers to make sure the Renegade camp to the south of Mankara is destroyed.</font>",
		"<span class='green'><font size=2>...For adventurers to make sure the gecko tribes camp south of Mankara on the main road has been cleared out.</font>",
		...
		"<span class='green'><font size=2>...For the citizens to write more books. There should be a spare computer for doing so in the Mankara school.</font>",
