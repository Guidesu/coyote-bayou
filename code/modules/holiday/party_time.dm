...
/datum/holiday/weekly/potluck/on_join_game(mob/living/newbie)
	to_chat(newbie, span_greenannounce("Looks like Mankara (and Ashdown too!) is throwing a party in the bar! Might be a great way to meet some people and make some friends! Or at the very least get some free food!"))
