...
/obj/item/clothing/head/helmet/armyhelmet/heavy
	...
	desc = "a steel helmet, inspired by several pre-war designs. This one has been modified by Mankara citizens to provide more protection to the face and neck."
