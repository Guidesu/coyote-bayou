...
/obj/item/clothing/under/f13/combat/militia
	name = "NDF fatigues"
	desc = "An olive-green combat uniform, issued to members of the Mankara Defense Force."
...
/obj/item/clothing/under/f13/general/oasis
	...
	desc = "A grim looking overcoat - preferable standard for the ruler of Mankara.<br>It's decorated with golden stars, each one adorned with a tree."
