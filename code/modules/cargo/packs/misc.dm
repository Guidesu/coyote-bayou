...
/datum/supply_pack/misc/capsule
	...
	desc = "A basic C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsuleluxury
	...
	desc = "A luxury C.A.M.P. capsule packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 600
...
/datum/supply_pack/misc/capsuleluxuryelite
	...
	desc = "A luxury bar C.A.M.P. capsule packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 800
...
/datum/supply_pack/misc/capsulesuper
	...
	desc = "The best of the best, no luxury witheld super-deluxe C.A.M.P. packed and designed by the Mankara Trade Union. Dispensers, machinery, sleeping quarters, vendors, it has it all.  Shake it and throw it!"
	cost = 1000
...
/datum/supply_pack/misc/capsulepremium
	...
	desc = "An intermediatly priced, carpeted, C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 500
...
/datum/supply_pack/misc/capsulequad
	...
	desc = "An expanded tent with four living quarters and a soda fountain C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsulemerchant
	...
	desc = "A partially covered merchants stall.  This one has a sleeping quarters too. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsuleparty
	...
	desc = "A large, spacious tent with a booze dispenser and some food. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsulekitchen
	...
	desc = "A rapid, ready to deploy field mess kitchen. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsulefarm
	...
	desc = "A ready to go, loaded farming plot with three brahmin, and a small living quarter. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsulefortune
	...
	desc = "A camp with three brahmin and all your supernatural needs. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
...
/datum/supply_pack/misc/capsulesmith
	...
	desc = "An all-in-one smithery, with a workbench, lathe, and forge as its key components. C.A.M.P. packed and designed by the Mankara Trade Union.  Shake it and throw it!"
	cost = 400
