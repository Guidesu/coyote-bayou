...
/mob/living/simple_animal/attack_ghost(mob/user, latejoinercalling)
	...
	if(lazarused)
		...
		to_chat(user, span_alert("You will be bound to serving a certain person, and very likely will be required to be friendly to Mankara and its citizens! Just something to keep in mind!"))
		var/mob/the_master
		...
		if(the_master)
			...
			to_chat(user, span_alert("Your master will be Mankara and its citizens, protect them at all costs!"))
...
/mob/living/simple_animal/proc/become_the_mob(mob/user)
	...
	if(lazarused)
		...
		to_chat(src, span_alert("You will be bound to serving a certain person, and very likely will be required to be friendly to Mankara and its citizens! Just something to keep in mind!"))
		var/mob/the_master
		if(isweakref(lazarused_by))
			the_master = lazarused_by.resolve()
		if(the_master)
			...
			to_chat(src, span_alert("Your master is be Mankara and its citizens, protect them at all costs!"))
			if(mind)
				mind.store_memory("You have been lazarus injected or tamed, and are bound to serve the town of Mankara and protect its people.")
			log_game("[key_name(src)] has been informed that they ([name]) are lazarus injected/tamed, and will serve Mankara.")
