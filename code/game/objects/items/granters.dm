...
/obj/item/book/granter/crafting_recipe/ODF
	name = "Weapons of Mankara and the Mankara Defense Force"
	...
	remarks = list("Looks like Mankara hand-crafts replicas from a pre-war police armory", "Some of these weapons are more than 200 years old....", "Duct tape really can hold it together!", "So that is how you laminate armor sheets together", "Looks like you can beat metal into just the right shape to replace the bits")
